...
public class DocumentDao {
    ...
    public DocumentDto getDocument(String id, PermType perm, List<String> targetIdList) {
        ...
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        StringBuilder sb = new StringBuilder("select distinct d.DOC_ID_C, d.DOC_TITLE_C, d.DOC_COUNTRY_OF_RESIDENCE_C, d.DOC_RACE_C, d.DOC_NAME_C,  d.DOC_HIGHEST_HELD_DEGREE_C, d.DOC_PREVIOUS_INSTITUTE_C, d.DOC_DEGREE_DATE_D, d.DOC_CURRENT_POSITION_C, d.DOC_CURRENT_GPA_C, d.DOC_DESCRIPTION_C, d.DOC_GPASCALE_C, d.DOC_CMUCOLLEGE_C, d.DOC_SUBJECT_C, d.DOC_IDENTIFIER_C, d.DOC_PUBLISHER_C, d.DOC_FORMAT_C, d.DOC_SOURCE_C, d.DOC_TYPE_C, d.DOC_COVERAGE_C, d.DOC_RIGHTS_C, d.DOC_CREATEDATE_D, d.DOC_UPDATEDATE_D, d.DOC_LANGUAGE_C, ");
        ...
        documentDto.setCountryOfResidence((String) o[i++]);
        ...
        documentDto.setCurrentPosition((String) o[i++]);
        documentDto.setCurrentGPA(((Number) o[i++]).floatValue());
    ...
    public Document update(Document document, String userId) {
        ...
        documentDb.setCountryOfResidence(document.getCountryOfResidence());
        documentDb.setRace(document.getRace());
        documentDb.setName(document.getName());
        documentDb.setHighestHeldDegree(document.getHighestHeldDegree());
